...
class Predicate : Expression<object>
{
    ...
    public override ExpressionType Category => ExpressionType.Predicate;
    ...
    {
        error = "";
        if (!(expression.Category is ExpressionType.Boolean))
        {
        ...
        if (expression.Category is ExpressionType.Object)
        {
