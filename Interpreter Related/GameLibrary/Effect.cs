...
namespace GameLibrary
{
    ...
    {
        public delegate bool EffectDelegate(Context context);

        static readonly Dictionary<string, EffectDelegate> effects = new Dictionary<string, EffectDelegate>
        {
            {"1", PutsAnAugment }, 
            {"2", PutsAWeather },
        ...
        public static void AllocateEffect(string number, EffectDelegate effect) => effects.Add(number, effect);

        public static EffectDelegate GetEffect(string number)
        {
            try
            {
        ...
        public static bool PutsAnAugment(Context context)
        {
            ...
            AugmentCard army = new AugmentCard("Army", Faction.Clouds, CardType.Augment, new List<Zone> { Zone.Distance }, 1.8);
